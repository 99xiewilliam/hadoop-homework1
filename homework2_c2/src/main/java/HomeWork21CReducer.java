...
public class HomeWork21CReducer extends Reducer<Text, Text, Text, NullWritable> {
...
//
//        for (Map.Entry<Set<String>, Double> entry : mapAno.entrySet()) {
...
//            context.write(new Text(keyList.get(0) + " " + keyList.get(1) + " " + keyList.get(2)), NullWritable.get());
//            i++;
//            if (i == limited) {
//                break;
//            }
